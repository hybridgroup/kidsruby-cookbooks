...
# run chef
chroot "$REMASTER_HOME/remaster-root" /bin/bash -c 'chef-solo -c /tmp/customization-scripts/chef/config/solo.rb -j /tmp/customization-scripts/chef/config/dna.json'
